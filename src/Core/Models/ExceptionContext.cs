...
namespace Core.Models
{
    ...
    public class ExceptionContext
    {
        ...
        /// <summary>
        /// Gets or sets the timestamp representing the current date and time in ISO 8601 format.
        /// </summary>
        /// <remarks>The timestamp is initialized to the current UTC date and time when the property is
        /// first set.</remarks>
        public DateTimeOffset Timestamp { get; set; } = DateTimeOffset.UtcNow;
        /// <summary>
        /// Gets or sets the severity level of the current operation or event.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the stack trace information associated with an error or exception.
        /// </summary>
        public string StackTrace { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets the message associated with the operation or event.
        /// </summary>
        public string Message { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets the name of the service associated with the current operation.
        /// </summary>
        public string Service { get; set; } = string.Empty;

        /// <summary>
        /// The Environment that this fault occurred in, e.g., Production, Staging, Development.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the source identifier associated with the current object.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the name of the target site.
        /// </summary>
        public string TargetSite { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets the exception instance that caused the current exception.
        /// </summary>
        public IList<string> InnerException { get; set; } = [];

        /// <summary>
        /// Gets or sets the identifier of the currently managed thread.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the unique identifier for the occurrence of an exception.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the schema data for the hotel, represented as a dictionary of key-value pairs.
        /// </summary>
