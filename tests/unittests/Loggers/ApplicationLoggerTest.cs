...
public class ApplicationLoggerTest : UnitTestsBase
{
    ...
    public void AnalyzeAndPublishFaultAsync_UsesCacheIfAvailable()
    {
        ...
        var cachedEvent = new ChatCompletionResponse()
        {
            Choices =
             [
        ...
        var cacheId = ExceptionHashGenerator.GetExceptionHash(exception);
        logger.LogEventsCache.TryAdd(cacheId, cachedEvent);

        // Act
        logger.AnalyzeAndPublishFaultAsync(exception, logEvent);
    ...
    [Fact]
    public void ExceptionHashGenerator_SameExceptionProducesSameHash()
    {
        // Arrange
        ...
        var hash1 = ExceptionHashGenerator.GetExceptionHash(ex1);
        var hash2 = ExceptionHashGenerator.GetExceptionHash(ex2);
    ...
    [Fact]
    public void ExceptionHashGenerator_DifferentStackTraceProducesDifferentHash()
    {
        // Arrange
        string hash1, hash2;
        try
        ...
        {
            hash1 = ExceptionHashGenerator.GetExceptionHash(e1);
        }
        try
        {
            ThrowExceptionB();
        ...
        {
            hash2 = ExceptionHashGenerator.GetExceptionHash(e2);
        }
        // Assert
