...
public class UnitTestsBase
{
    ...
    public sealed class TestLogEvent : ILogEvent
    {
        /// <summary>
...
public sealed class MockPublisher : IPublisher
{
    /// <summary>
    ...
    public sealed class MockEventListener(Action<EventWrittenEventArgs> onEventWritten) : EventListener
    {
        /// <summary>
...
public sealed class MockLogger(LogLevel logLevel, IPublisher publisher = null) : ILogger
{
